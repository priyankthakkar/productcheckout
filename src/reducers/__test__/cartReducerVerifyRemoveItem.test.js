...
test('reducers CART_UPDATE_SUCCESS remove item', () => {
  const state = reducers(
    {
      ...
      error: null,
      cart: {
        cartItems: [{ productCode: 'wf', quantity: 2 }],
        cartValue: { total: '399.98', discount: 0, payable: '399.98' },
      },
      promo: {
        promos: [
          {
    ...
    { type: 'CART_UPDATE_SUCCESS', cartItems: [{ productCode: 'wf', quantity: 1 }] },
  );
