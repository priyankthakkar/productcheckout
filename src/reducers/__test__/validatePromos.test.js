...
test('On reducing product quantity, promos not applicable should be removed', () => {
  const state = reducers(
    {
      ...
      error: null,
      cart: {
        cartItems: [{ productCode: 'wf', quantity: 5 }],
        cartValue: { total: '999.95', discount: '0.00', payable: '999.95' },
      },
      promo: {
        promos: [
          {
    ...
    { type: 'PROMO_VALIDATE_SUCCESS', appliedPromos: [] },
  );
